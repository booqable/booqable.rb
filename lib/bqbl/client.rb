...
module BQBL
  ...
  class Client
    ...
    # @see BQBL::Configurable For a complete list of supported configuration options
    def initialize(options = {})
      ...
      BQBL::Configurable.keys.each do |key|
        value = options[key].nil? ? BQBL.instance_variable_get(:"@#{key}") : options[key]
    ...
    # @example
    #   client = BQBL::Client.new(api_key: "secret123")
    #   client.inspect #=> "#<BQBL::Client:0x... @api_key=\"*********\">"
    def inspect
      inspected = super
