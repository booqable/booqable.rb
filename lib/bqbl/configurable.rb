...
module BQBL
  ...
  module Configurable
    ...
    class << self
      # List of configurable keys for {BQBL::Client}
    ...
    def reset!
      ...
      BQBL::Configurable.keys.each do |key|
        ...
        instance_variable_set(:"@#{key}", BQBL::Default.options[key])
      end
      self
    end
    alias setup reset!
    ...
    def options
      BQBL::Configurable.keys.to_h { |key| [ key, instance_variable_get(:"@#{key}") ] }
    end
  end
end
