module BQBL
  ...
  class JsonApiSerializer
    ...
    #
    # @return [BQBL::JsonApiSerializer] A serializer instance
    ...
    #
    # @return [BQBL::JsonApiSerializer, nil] Serializer instance or nil if Yajl unavailable
    def self.yajl
      require "yajl"
      new(Yajl)
    rescue LoadError
    ...
    #
    # @return [BQBL::JsonApiSerializer, nil] Serializer instance or nil if JSON unavailable
    def self.json
      require "json"
      new(JSON)
    rescue LoadError
    ...
    #
    # @return [BQBL::JsonApiSerializer, nil] Serializer instance or nil if MultiJson unavailable
    def self.multi_json
      require "multi_json"
      new(MultiJson)
    rescue LoadError
    ...
    #
    # @return [BQBL::JsonApiSerializer, nil] Serializer instance or nil if MessagePack unavailable
