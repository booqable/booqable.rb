...
module BQBL
  ...
  module Default
    ...
    USER_AGENT   = "BQBL Ruby Gem #{BQBL::VERSION}"
    ...
    RETRY_OPTIONS = {
      exceptions: Faraday::Retry::Middleware::DEFAULT_EXCEPTIONS + [ BQBL::ServerError ],
    ...
    class << self
      ...
      # @return [Hash]
      def options
        BQBL::Configurable.keys.to_h { |key| [ key, send(key) ] }
      end
