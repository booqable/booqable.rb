...
describe BQBL::Client do
  describe "configuration validation" do
    it "raises CompanyRequired when company is not set" do
      ...
      expect { client.send(:api_endpoint) }.to raise_error(BQBL::CompanyRequired)
    end
  ...
  describe "module configuration" do
    ...
    describe "with class level configuration" do
      ...
      it "uses defaults when parameters are nil" do
        ...
        client = BQBL::Client.new(new_opts)
        expect(client.api_endpoint).to eq(BQBL.api_endpoint)
      end

      it "overrides module configuration" do
        client = BQBL::Client.new(@opts)
        expect(client.per_page).to eq(40)
        expect(client.auto_paginate).to eq(BQBL.auto_paginate)
        expect(client.client_id).to eq(BQBL.client_id)
      end
      ...
      it "masks api token on inspect" do
        client = BQBL::Client.new(api_token: "87614b09dd141c22800f96f11737ade5226d7ba8")
        inspected = client.inspect
        expect(inspected).not_to include("87614b09dd141c22800f96f11737ade5226d7ba8")
      end

      it "masks single use token on inspect" do
        client = BQBL::Client.new(single_use_token: "secret JWT")
        inspected = client.inspect
        expect(inspected).not_to include("secret JWT")
      end

      it "masks client secret on inspect" do
        client = BQBL::Client.new(client_secret: "87614b09dd141c22800f96f11737ade5226d7ba8")
        inspected = client.inspect
        expect(inspected).not_to include("87614b09dd141c22800f96f11737ade5226d7ba8")
      end

      it "masks client id on inspect" do
        client = BQBL::Client.new(client_id: "87614b09dd141c22800f96f11737ade5226d7ba8")
        inspected = client.inspect
        expect(inspected).not_to include("87614b09dd141c22800f96f11737ade5226d7ba8")
      end

      it "masks single use token private key on inspect" do
        client = BQBL::Client.new(single_use_token_private_key: "87614b09dd141c22800f96f11737ade5226d7ba8")
        inspected = client.inspect
        expect(inspected).not_to include("87614b09dd141c22800f96f11737ade5226d7ba8")
      end

      it "masks single use token secret on inspect" do
        client = BQBL::Client.new(single_use_token_secret: "87614b09dd141c22800f96f11737ade5226d7ba8")
        inspected = client.inspect
        expect(inspected).not_to include("87614b09dd141c22800f96f11737ade5226d7ba8")
      end
    end
  ...
  describe "authentication" do
    ...
    describe "with module level config" do
      ...
      it "sets api key with .configure" do
        ...
        expect(BQBL.client).to be_api_key_authenticated
        expect(BQBL.client).not_to be_oauth_authenticated
        expect(BQBL.client).not_to be_single_use_token_authenticated
      end

      it "sets api key with module methods" do
        BQBL.api_key = test_api_key
        expect(BQBL.client).to be_api_key_authenticated
        expect(BQBL.client).not_to be_oauth_authenticated
        expect(BQBL.client).not_to be_single_use_token_authenticated
      end
      ...
      it "sets oauth token with .configure" do
        ...
        expect(BQBL.client).to be_oauth_authenticated
        expect(BQBL.client).not_to be_api_key_authenticated
        expect(BQBL.client).not_to be_single_use_token_authenticated
      end

      it "sets oauth token with module methods" do
        BQBL.client_id = test_client_id
        BQBL.client_secret = test_client_secret
        expect(BQBL.client).to be_oauth_authenticated
        expect(BQBL.client).not_to be_api_key_authenticated
        expect(BQBL.client).not_to be_single_use_token_authenticated
      end
      ...
      it "sets single use token with .configure" do
        ...
        expect(BQBL.client).to be_single_use_token_authenticated
        expect(BQBL.client).not_to be_api_key_authenticated
        expect(BQBL.client).not_to be_oauth_authenticated
      end

      it "sets single use token with module methods" do
        BQBL.single_use_token_company_id = test_single_use_token_company_id
        BQBL.single_use_token_user_id = test_single_use_token_user_id
        BQBL.single_use_token_algorithm = test_single_use_token_algorithm
        BQBL.single_use_token = test_single_use_token
        BQBL.single_use_token_secret = test_single_use_token_private_key
    ...
    describe "when oauth authenticated" do
      ...
      it "handles OAuth2 errors during token refresh" do
        ...
        # Mock BQBL::Error.from_response to raise an appropriate error
        allow(BQBL::Error).to receive(:from_response).and_raise(BQBL::Unauthorized)

        expect { client.get("/orders") }.to raise_error(BQBL::Unauthorized)
      end
      ...
      it "injects oauth middleware when oauth authenticated" do
        ...
        expect(builder).to receive(:use).with(BQBL::Middleware::Auth::OAuth, hash_including(
          client_id: test_client_id,
          client_secret: test_client_secret
        ))
        expect(builder).not_to receive(:use).with(BQBL::Middleware::Auth::ApiKey, anything)
        expect(builder).not_to receive(:use).with(BQBL::Middleware::Auth::SingleUse, anything)
      ...
      it "does not inject oauth middleware when not oauth authenticated" do
        ...
        builder = double("Builder")
        expect(builder).not_to receive(:use).with(BQBL::Middleware::Auth::OAuth, anything)
        expect(builder).to receive(:use).with(BQBL::Middleware::Auth::ApiKey, hash_including(
          api_key: test_api_key
        ))
        expect(builder).not_to receive(:use).with(BQBL::Middleware::Auth::SingleUse, anything)
    ...
    describe "when single use token authenticated" do
      ...
      describe "JWT payload validation" do
        it "includes required claims in JWT payload" do
          ...
          allow_any_instance_of(BQBL::Middleware::Auth::SingleUse).to(
      ...
      describe "error handling" do
        it "raises error when algorithm is missing" do
          expect do
            ...
            client.get("/orders")
          end.to raise_error(BQBL::SingleUseTokenAlgorithmRequired)
        end
        ...
        it "raises error when company_id is missing" do
          expect do
            ...
            client.get("/orders")
          end.to raise_error(BQBL::SingleUseTokenCompanyIdRequired)
        end
        ...
        it "raises error when user_id is missing" do
          expect do
            ...
            client.get("/orders")
          end.to raise_error(BQBL::SingleUseTokenUserIdRequired)
        end
        ...
        it "raises error when private_key is missing" do
          expect do
            ...
            client.get("/orders")
          end.to raise_error(BQBL::PrivateKeyOrSecretRequired)
        end
      end
    end
  end
  ...
  describe ".agent" do
    ...
    it "acts like a Sawyer agent" do
      expect(BQBL.client.agent).to respond_to :start
    end
  ...
  describe ".get", :vcr do
    before(:each) do
      BQBL.reset!
      BQBL.company = "demo"
      BQBL.api_domain = "booqable.test"
    end

    it "handles query params" do
      request = stub_get("/orders")
        .with(query: { foo: "bar" })
      BQBL.get "/orders", foo: "bar"
    ...
    it "handles headers" do
      ...
      BQBL.get "/zen", foo: "bar", accept: "text/plain"
      assert_requested request
    end
  end # .get
  ...
  describe ".head", :vcr do
    ...
    it "handles headers" do
      request = stub_head("/zen")
                .with(query: { foo: "bar" }, headers: { accept: "text/plain" })
      BQBL.head "/zen", foo: "bar", accept: "text/plain"
      assert_requested request
    end
  end # .head
  ...
  describe "when making requests" do
    ...
    it "sets a default user agent" do
      orders_request = stub_get("/orders")
                     .with(headers: { user_agent: BQBL::Default.user_agent })
      @client.get "/orders"
      assert_requested orders_request
      expect(@client.last_response.status).to eq(200)
    end
    ...
    it "sets a custom user agent" do
      ...
      client = BQBL::Client.new(user_agent: user_agent)
      client.get "/orders"
      assert_requested orders_request
      expect(client.last_response.status).to eq(200)
    end
    ...
    it "sets a proxy server" do
      ...
      conn = BQBL.client.send(:agent).instance_variable_get(:@conn)
  ...
  context "error handling" do
    ...
    it "raises on 404" do
      ...
      expect { BQBL.get("/booya") }.to raise_error BQBL::NotFound
    end

    it "raises on 401" do
      stub_get("/unauthorized").to_return(status: 401)
      expect { BQBL.get("/unauthorized") }.to raise_error BQBL::Unauthorized
    end

    it "raises on 403" do
      stub_get("/forbidden").to_return(status: 403)
      expect { BQBL.get("/forbidden") }.to raise_error BQBL::Forbidden
    end

    it "raises on 405" do
      stub_get("/not_allowed").to_return(status: 405)
      expect { BQBL.get("/not_allowed") }.to raise_error BQBL::MethodNotAllowed
    end

    it "raises on 406" do
      stub_get("/not_acceptable").to_return(status: 406)
      expect { BQBL.get("/not_acceptable") }.to raise_error BQBL::NotAcceptable
    end

    it "raises on 409" do
      stub_get("/conflict").to_return(status: 409)
      expect { BQBL.get("/conflict") }.to raise_error BQBL::Conflict
    end

    it "raises on 410" do
      stub_get("/deprecated").to_return(status: 410)
      expect { BQBL.get("/deprecated") }.to raise_error BQBL::Deprecated
    end

    it "raises on 415" do
      stub_get("/unsupported").to_return(status: 415)
      expect { BQBL.get("/unsupported") }.to raise_error BQBL::UnsupportedMediaType
    end

    it "raises on 423" do
      stub_get("/locked").to_return(status: 423)
      expect { BQBL.get("/locked") }.to raise_error BQBL::Locked
    end

    it "raises on 429" do
      stub_get("/rate_limited").to_return(status: 429)
      expect { BQBL.get("/rate_limited") }.to raise_error BQBL::TooManyRequests
    end

    it "raises on 500" do
      stub_get("/boom").to_return(status: 500)
      expect { BQBL.get("/boom") }.to raise_error BQBL::InternalServerError
    end

    it "raises on 501" do
      stub_get("/not_implemented").to_return(status: 501)
      expect { BQBL.get("/not_implemented") }.to raise_error BQBL::NotImplemented
    end

    it "raises on 502" do
      stub_get("/bad_gateway").to_return(status: 502)
      expect { BQBL.get("/bad_gateway") }.to raise_error BQBL::BadGateway
    end

    it "raises on 503" do
      stub_get("/service_unavailable").to_return(status: 503)
      expect { BQBL.get("/service_unavailable") }.to raise_error BQBL::ServiceUnavailable
    end
    ...
    it "includes a message" do
      ...
      begin
        BQBL.get("/boom")
      rescue BQBL::UnprocessableEntity => e
    ...
    it "knows the difference between different kinds of bad request" do
      ...
      expect { BQBL.get("/some/admin/stuffs") }.to raise_error BQBL::BadRequest
      ...
      expect { BQBL.get("/orders") }.to raise_error(BQBL::ReadOnlyAttribute)
      ...
      expect { BQBL.get("/orders") }.to raise_error(BQBL::UnknownAttribute)
      ...
      expect { BQBL.get("/orders") }.to raise_error BQBL::ExtraFieldsInWrongFormat
      ...
      expect { BQBL.get("/orders") }.to raise_error BQBL::FieldsInWrongFormat
      ...
      expect { BQBL.get("/orders") }.to raise_error BQBL::PageShouldBeAnObject
      ...
      expect { BQBL.get("/orders") }.to raise_error BQBL::FailedTypecasting
      ...
      expect { BQBL.get("/orders") }.to raise_error BQBL::InvalidFilter
      ...
      expect { BQBL.post("/orders") }.to raise_error BQBL::RequiredFilter
    end

    it "knows the difference between different kinds of payment required errors" do
      stub_get("/basic_payment").to_return(status: 402)
      expect { BQBL.get("/basic_payment") }.to raise_error BQBL::PaymentRequired
      ...
      expect { BQBL.get("/feature") }.to raise_error BQBL::FeatureNotEnabled
    ...
    it "knows the difference between different kinds of not found errors" do
      ...
      expect { BQBL.get("/company") }.to raise_error BQBL::CompanyNotFound
    end
    ...
    it "knows the difference between different kinds of service unavailable errors" do
      ...
      expect { BQBL.get("/basic_unavailable") }.to raise_error BQBL::ServiceUnavailable
      ...
      expect { BQBL.get("/readonly") }.to raise_error BQBL::ReadOnlyMode
    end
    ...
    it "knows the difference between different kinds of unprocessable entity" do
      ...
      expect { BQBL.get("/some/admin/stuffs") }.to raise_error BQBL::UnprocessableEntity
      ...
      expect { BQBL.post("/orders") }.to raise_error BQBL::InvalidDateTimeFormat
      ...
      expect { BQBL.post("/orders") }.to raise_error BQBL::InvalidDateFormat
    end
    ...
    it "raises on unknown client errors" do
      ...
      expect { BQBL.get("/orders") }.to raise_error BQBL::ClientError
    end
    ...
    it "raises on unknown server errors" do
      ...
      expect { BQBL.get("/orders") }.to raise_error BQBL::ServerError
    end
    ...
    it "resets last_response on errors" do
      ...
      expect { client.get("/orders") }.to raise_error BQBL::ServerError
      expect(client.last_response).to be_nil
    end
    ...
    it "returns context with default data when rate limit error occurs but headers are missing" do
      ...
      begin
        ...
        expect(e.context).to be_an_instance_of(BQBL::RateLimit)
      end
    end
  ...
  describe "HTTP methods" do
    ...
    describe "PUT requests" do
      it "makes PUT requests using the put method" do
        ...
        BQBL.client.put "/orders/123", { name: "Updated Order" }
        assert_requested orders_request
      end
    end
    ...
    describe "PATCH requests" do
      it "makes PATCH requests using the patch method" do
        ...
        BQBL.client.patch "/orders/123", { name: "Patched Order" }
        assert_requested orders_request
      end
    end
  ...
  describe "BQBL::UnsupportedAPIVersion" do
    it "has the correct error message" do
      # Test line 398 - super call in initialize
      expect { raise BQBL::UnsupportedAPIVersion.new }.to raise_error(
        BQBL::UnsupportedAPIVersion,
        "Unsupported API version configured. Only version '4' is supported."
      )
    end

    it "inherits from ConfigArgumentError" do
      error = BQBL::UnsupportedAPIVersion.new
      expect(error).to be_a(BQBL::ConfigArgumentError)
